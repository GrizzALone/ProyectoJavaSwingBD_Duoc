...
{
   public boolean ingresarTrabajador(Trabajador tt) //LISTO
   {
   ...
   public boolean modificarTrabajador(Trabajador tt) //LISTO
    {
        boolean resultado=false;
        try {
            Connection con=Conexion.getConexion();
   ...
   public boolean eliminarTrabajador(String rut) //LISTO
    {
        boolean resultado=false;
        try {
            Connection con=Conexion.getConexion();
    ...
    public Trabajador buscarTrabajador(String rut) //LISTO
    {   
        Trabajador tra=null;
        try {
            Connection con=Conexion.getConexion();
